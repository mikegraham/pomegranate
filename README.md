...
Lastly, you can also download the zip and manually move the files into your site-packages folder (or to a directory on your `PYTHONPATH`, if you've changed it).
